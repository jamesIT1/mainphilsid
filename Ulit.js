document.addEventListener('DOMContentLoaded', function() {
    ...
    if (carousel) {
        ...
        function goToSlide(index) {
            // If we are already on the requested slide, do nothing.
            // This prevents restarting the text animation if a timer fires for the current slide.
        ...
        // Initial setup
        // No resize listener needed for fade carousel
        goToSlide(0);
        startAutoSlide();
    }
